# APIs.io Tags API
This is the API for managing tags used as part of the APis.io API search engine.

There are two things going on this repository.

- **AWS Lambda API** - The actual deployment of the APIs.io Tags API.
...
# Links
This API is just one module in a suite of APIs supporting the APIs.io Tags engine.

- [Website](https://apis-io-site.apievangelist.com) - The website for the APIs.io Tags engine.
- [Developer Portal](https://apis-io-api.apievangelist.com) - The developer portal for the APIs.io Tags egine.

You can get to all of the rest of the APIs using the developer portal, and Tags via website.